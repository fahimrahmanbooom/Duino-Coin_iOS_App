...
## Installation
- Clone the repo. Install the app using Xcode or Use the attached IPA file to install or download it from here: https://appforshare.io/i/b6YE8l . Use safari to install it from the drive. Due to apple's restrictions the app is not available on the appstore.
